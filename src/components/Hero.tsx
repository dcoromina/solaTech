...
const HeroSection = () => {
  return (
    <div className="min-h-[80vh] flex flex-col items-center justify-center gap-12 px-4 py-16 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-[900px] flex flex-col items-center gap-6 relative z-10">
        ...
        <h1 className="font-bold text-white lg:text-6xl md:text-5xl text-4xl text-center leading-tight tracking-tight">
        ...
        <div className="mt-6 flex flex-col sm:flex-row gap-4">
          ...
          <button className="px-8 py-4 bg-white/10 text-white rounded-xl font-medium hover:scale-105 transition-all duration-200 border border-white/20 backdrop-blur-sm">
            Watch Demo
          </button>
        </div>
      </div>
