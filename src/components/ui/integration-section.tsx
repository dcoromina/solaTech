...
const apiFeatures = [
  {
    ...
    title: "RESTful APIs",
    description: "Modern, developer-friendly APIs with comprehensive documentation"
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            Seamlessly integrate with your existing healthcare ecosystem. Our platform connects with 
            leading EHR systems, medical devices, and third-party applications.
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 rounded-2xl p-8 border border-blue-500/20">
          <div className="text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
              Get started quickly with our comprehensive documentation, SDKs, and developer tools.
            </p>
